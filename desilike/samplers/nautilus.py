...
class NautilusSampler(BasePosteriorSampler):
    ...
    def _run_one(self, start, min_iterations=0, max_iterations=sys.maxsize, check_every=300, check=None, **kwargs):
        ...
        # Use vectorized likelihood evaluation to leverage desilike's MPI-aware vmap.
        # Pool-based per-point parallelism conflicts with logposterior's MPI broadcast.
        pool = None
